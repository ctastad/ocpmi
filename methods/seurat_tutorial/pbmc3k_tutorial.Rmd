...
setwd("~/starr_lab/ocpmi/methods/seurat_tutorial/")
pbmc.data <- Read10X(data.dir = "~/starr_lab/ocpmi/methods/seurat_tutorial/filtered_gene_bc_matrices/hg19/")
...
saveRDS(pbmc, file = "~/starr_lab/ocpmi/methods/seurat_tutorial/")
```
...
ggsave(filename = "~/starr_lab/ocpmi/methods/seurat_tutorial/pbmc3k_umap.png", height = 7, width = 12, plot = plot)
```

```{r save.rds, eval=F}
saveRDS(pbmc, file = "~/starr_lab/ocpmi/methods/seurat_tutorial/pbmc3k_final.rds")
```
