...
```{r}
* samples: `sample` via ocpmi; `~/ocpmi/data/bam/wes`
...
*gene_ref, gtf &rarr; `genomeGenerate` indexing &rarr; `align` + `sort` &rarr; output.bam*
...
```{r}
isub -n nodes=1:ppn=6 -m 16GB -w 8:00:00
```
