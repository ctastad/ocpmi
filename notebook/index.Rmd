...
I'm running several different permutations of my pilot bam samples to get a sense of how these results come out against the `NA10847` control. To a certain extent, I am just taking a shotgut approach to have a variety of cases to compare. Part of this included minor tweaking to the `full_send.sh` script.

**ocpmi_vs_1kgp_2pm_50k2**
...
got gtf file from ucsc genome table browser (@Karolchik2004)

* https://hbctraining.github.io/Intro-to-rnaseq-hpc-O2/lessons/03_alignment.html
* (file:///mnt/msi/tasta005/ocpmi/reference/gene_markers/STARmanual.pdf)[file:///mnt/msi/tasta005/ocpmi/reference/gene_markers/STARmanual.pdf]
