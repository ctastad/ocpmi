...
Didn't get a lot of concrete work done today. Something randommly changed the permissions for my working directory today. I'm at a complete loss for why that would have happened. I was able to fix it for my file permissions, but my ssh keys are still not working. I don't know if those things are related, but they are equally weird and occured at the same time.
...
The latest error I'm getting from the seq alignment process is the result of a lack of disk space. Aparently, I've taken up a massive amount of space with these wes files and will need to figure out how to manage those effectively since they are so large.
...
changed a couple minor things in full_send that may be causing problems
running excv2_full_send
started pileup creation for vs2- job: 816769
