...
* Read papers on excavator, varscan2, scope and assess which would be best. Run on one dataset.
* We discussed the source exome data since I wanted to clarify my understanding of this. The wes tissue can effectivley be assumed to be the same source as the scRNA for each pt.
