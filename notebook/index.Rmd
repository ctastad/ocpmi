...
I am redoing the sequence alignment on my fastq files out of fear that bwa is dated and does not have specific enough parameters to deal with our highliy variable dataset. The package requires a gtf file in order to index the gene reference. I retrieved this from the ucsc genome table browser (@Karolchik2004)
