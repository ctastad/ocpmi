...
The layout is generally centered here on the `Log`, which is meant as a full continuum of work and notation completed while in the Starr lab. Elements of this page have been pulled as special points of reference when they need a relevant context such as a repeatedly used `method` or notable `results`. References used on each specific page are displayed at the bottom, and all references used across the notebook and bibliography at large (library.bib located in the `starr_lab/ocpmi/notebook/` directory) are collated on the `References` page.
...
2019-06-17 2019-07-08 3w    lab.ccgd email oit points of contact to get rhel
                                     server access
                                       2019-06-17 Look on page 5 of the attached
                                     CCGD project document, there are three
                                     dated conversations that I have had with
                                     the OIT people. The last conversation
                                     includes a link to spreadsheet we need to
                                     fill out and a link to what they have to
                                     fill out, including a link to some branding
                                     considerations. Let me know if you need
                                     more than that.
