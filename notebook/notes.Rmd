...
I ran the v3 Seurat tutorial to completion using the pbmc dataset. This outline was very intuitive and worked through the pipeline seamlessly. There are several points that warrant further explanation.

```{r}
shiny::includeHTML("/home/chris/starr_lab/ocpmi/code/seurat_tutorial/pbmc3k_tutorial.html")
```
